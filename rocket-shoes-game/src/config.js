...
export const VERSION = '1.3.0-rocket-shoes';
...
export const PLAYER = {
  ...
  FIRE_DELAY: 0.15, DAMAGE: 0.88, SHOT_MULT: 0.72, SHOT_SPEED: 880,
  ...
  // RANGE = how far it looks, CONE = min alignment (dot) to count as "ahead" (~58°),
  // MAX = hardest it will ever bend the dash (radians; ~24° — an assist, not auto-aim).
  DASH_HOMING_RANGE: 560, DASH_HOMING_CONE: 0.52, DASH_HOMING_MAX: 0.42,
