...
export function showCodex(menu = menuRef, fromDeath = false) {
  ...
  const html =
    ...
    `<h3 style="margin:10px 0 6px">Playtest Notes</h3><div class="noticeList">Fast movement · giant readable maps · homing dash polish · muted popups.</div>`;
...
export function whisper(_text) {
  // Muted for this playtest: no bottom-of-screen joke/behavior popups.
  // Kept as a no-op so existing room events can call it safely.
}
